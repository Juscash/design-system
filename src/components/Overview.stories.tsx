...
import {
  ...
  ListChecks as IconRichRadioGroup,
  Radio as IconRichRadio,
  CheckCircle as IconRichCheckbox,
  Settings2 as IconRichSwitch,
...
const categories: Category[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { name: "RichCheckbox", description: "Checkbox com título e descrição em card.", icon: IconRichCheckbox },
      { name: "RichRadio", description: "Radio expandido com título e descrição.", icon: IconRichRadio },
      { name: "RichRadioGroup", description: "Grupo de RichRadios com seleção única.", icon: IconRichRadioGroup },
      { name: "RichSwitch", description: "Switch com título e descrição em card.", icon: IconRichSwitch },
